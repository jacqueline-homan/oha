	    ...
	    <div class="col_16">
			<?php
				if(is_page('services'))
				{
					$menus = array( 
	                	array(
	                		...
	                		'url'	=> "/wp-content/uploads/2013/02/icon-testing.png",
	                		'link'	=> "/services/wellness-testing/",
	                		'description' => "Gentle, naturopathic testing methods help us to triangulate the source of your dis-ease."
	                	),
	                	array(
	                		'title' => "Browse Services",
	                		'url'	=> "/wp-content/uploads/2013/03/icon-browsing.png",
	                		'link'	=> "/services/browse-services/",
	                		'description' => "Start managing your personal wellness today. Our holistic therapies are tailored to your needs."
	                	)
	                );	
				} else
				{
				...
				if ( $menutitle ) { 	
	                ...
	                echo '<p>'.$menudesc.'</p>';
	                echo '<p><a class="cta" href="'.$menulink.'" onclick="var _gaq = _gaq || []; _gaq.push([\'_trackEvent\', \'Landing Page CTAs\', \''.$menu['title'].'\']);"> '.__( 'Read More', 'bhinneka' ).' </a></p>';			
	                echo '</div></div>';
				}
            } ?>
		</div>
