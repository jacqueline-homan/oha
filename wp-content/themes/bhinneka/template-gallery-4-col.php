<?php
/*
Template Name: Gallery Page - 4 columns
*/
get_header(); ?>
				...
				<section class="module">
					...
					<div id="gallery-wrapper">
						...
						<ul id="module-wrapper" >
							...
							<li class="<?php foreach ($terms as $term) { echo strtolower(preg_replace('/\s+/', '-', $term->name)). ' '; } ?> gallery_col_four module-box <?php if ( $count % 4 == 0 ) echo' omega';?>" data-id="id-<?php echo $count; ?>">
								<!-- Post begin -->
