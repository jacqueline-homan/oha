<?php
class add_bnk_button {
    var $pluginname = 'bnk_sceditor';
    var $path = '';
    var $internalVersion = 100;
    function add_bnk_button() {
    ...
    function add_tinymce_langs_path($plugin_array) {
        ...
        $plugin_array[$this->pluginname] = TEMPLATEPATH . '/functions/tinymce/languages.php';
        return $plugin_array;
    }
...
if (is_admin()){
    $tinymce_button = new add_bnk_button();
}
?>